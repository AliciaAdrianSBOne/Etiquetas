...
#End Region
    ...
    Private Sub btnAceptar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAceptar.Click
        If lvArticulos.SelectedIndices.Count <> 0 Then
            ...
            For Each i In lvArticulos.SelectedIndices
                FS_local.TextBox2.Text = lvArticulos.Items(i).SubItems(1).Text
            Next i
        End If
        Me.Close()
    End Sub
    ...
    Private Sub frmArt2_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            cmbTipo3.Items.Add("Descripcion")
            cmbTipo3.Items.Add("Codigo")

            cmbTipo3.SelectedItem = "Descripcion"
    ...
    Private Sub ArticulosCargar()
        ...
        If cmbTipo3.SelectedItem.ToString.ToUpper.Equals("CODIGO") Then
            condicion = " T0.ItemCode LIKE '%" + TbBusca.Text + "%'"
        ElseIf cmbTipo3.SelectedItem.ToString.ToUpper.Equals("DESCRIPCION") Then
