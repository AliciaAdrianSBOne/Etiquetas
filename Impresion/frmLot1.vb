...
#End Region
    ...
    Private Sub btnAceptar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAceptar.Click
        If lvArticulos.SelectedIndices.Count <> 0 Then
            ...
            For Each i In lvArticulos.SelectedIndices
                FS_local.TextBox9.Text = lvArticulos.Items(i).SubItems(1).Text
            Next i
        End If
        Me.Close()
    End Sub
    ...
    Private Sub frmArt1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            cmbTipo2.Items.Add("DVD")
            cmbTipo2.Items.Add("Lote")

            cmbTipo2.SelectedItem = "Lote"

            'ArticulosCargar()

        Catch ex As Exception
            MessageBox.Show("frmLot1_Load: " & ex.Message)
        End Try
    End Sub
    ...
    Private Sub LotesCargar()
        ...
        If cmbTipo2.SelectedItem.ToString.ToUpper.Equals("LOTE") Then
            condicion = " T0.DistNumber LIKE '%" + TbBusca.Text + "%'"
        ElseIf cmbTipo2.SelectedItem.ToString.ToUpper.Equals("DVD") Then
