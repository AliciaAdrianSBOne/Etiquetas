...
#End Region
    ...
    Private Sub btnAceptar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAceptar.Click
        If lvAlbaranes.SelectedIndices.Count <> 0 Then
            ...
            For Each i In lvAlbaranes.SelectedIndices
                FS_local.TextBox7.Text = lvAlbaranes.Items(i).SubItems(1).Text
                FS_local.CB5.Checked = True
            Next i
        End If
        Me.Close()
    End Sub

    Private Sub frmAlb1_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
        ...
        Catch ex As Exception
            MessageBox.Show("frmAlbB1_Load: " & ex.Message)
        End Try
    End Sub
    ...
    Private Sub AlbaranesCargar()
        ...
        Try
            ...
            With lCmd
                ...
                If TbBusca.Text.Equals(String.Empty) Then
                    .CommandText = " SELECT T0.DocEntry, T0.DocNum, T0.DocDate, T0.CardCode, T0.CardName, T0.DocTotal " & _
                                   " from ODRF T0 " & _
                                   " WHERE ObjType = 20 " & _
            ...
            While lDR.Read
                With lvAlbaranes
                    .Items.Add("")
                    .Items(.Items.Count - 1).SubItems.Add(lDR.Item("DocEntry").ToString)
        ...
        Catch ex As Exception
            MessageBox.Show("frmAlb1.AlbaranesBorradorCargar: " & ex.Message)
        Finally
        ...
        End Try
    End Sub
    Private Sub frmAlb1_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
    ...
    Private Sub lvAlbaranes_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles lvAlbaranes.SelectedIndexChanged
        If lvAlbaranes.SelectedIndices.Count <> 0 Then
            Dim i As Int16
            For Each i In lvAlbaranes.SelectedIndices
                TSelAlb1.Text = lvAlbaranes.Items(i).SubItems(1).Text
            Next i
        End If
    End Sub
End Class