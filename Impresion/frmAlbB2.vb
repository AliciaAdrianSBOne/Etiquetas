...
#End Region
    ...
    Private Sub btnAceptar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAceptar.Click
        If lvAlbaranes.SelectedIndices.Count <> 0 Then
            ...
            For Each i In lvAlbaranes.SelectedIndices
                FS_local.TextBox8.Text = lvAlbaranes.Items(i).SubItems(1).Text
    ...
    Private Sub frmAlb2_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Catch ex As Exception
            MessageBox.Show("frmAlbB2_Load: " & ex.Message)
        End Try
    End Sub
    ...
    Private Sub AlbaranesCargar()
        ...
        Catch ex As Exception
            MessageBox.Show("frmAlbB2.AlbaranesCargar: " & ex.Message)
        Finally
    ...
    Private Sub lvAlbaranes_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If lvAlbaranes.SelectedIndices.Count <> 0 Then
            Dim i As Int16
            For Each i In lvAlbaranes.SelectedIndices
    ...
    Private Sub lvAlbaranes_SelectedIndexChanged_1(sender As System.Object, e As System.EventArgs) Handles lvAlbaranes.SelectedIndexChanged
