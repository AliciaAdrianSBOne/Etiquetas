...
#End Region
    ...
    Private Sub frmTra2_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
        ...
        Catch ex As Exception
            MessageBox.Show("frmTra2_Load: " & ex.Message)
        End Try
    End Sub
    ...
    Private Sub TrasladosCargar()
        ...
        Catch ex As Exception
            MessageBox.Show("frmTra2.TrasladosCargar: " & ex.Message)
        Finally
        ...
        End Try
    End Sub
    Private Sub frmTra2_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
    ...
    Private Sub btnAceptar_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAceptar.Click
        If lvTraslados.SelectedIndices.Count <> 0 Then
            Dim i As Int16
            For Each i In lvTraslados.SelectedIndices
                FS_local.TextBox12.Text = lvTraslados.Items(i).SubItems(1).Text
